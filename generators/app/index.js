...
module.exports = class extends Generator {
  ...
  prompting() {
    ...
    return this.prompt(prompts).then(props => {
      this.controlNamespace = this.options.controlNamespace || props.controlNamespace;
      this.controlName = this.options.controlName || props.controlName;
      this.controlTemplate = this.options.controlTemplate || props.controlTemplate;
  ...
  writing() {
    this.spawnCommandSync(`pac pcf init -ns ${this.controlNamespace} -n ${this.controlName} -t ${this.controlTemplate.toString().toLowerCase()}`);
    ...
    this.fs.copyTpl(
      this.templatePath(`_manifest-${this.controlTemplate.toString().toLowerCase()}.xml`),
    ...
    var normalizedPublisherName = this.publisherName.replace(/ /g, '').toLowerCase();
    var normalizedPublisherPrefix = this.publisherPrefix.replace(/ /g, '').toLowerCase();
